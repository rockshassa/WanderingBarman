...
extension Menu {
    static var allItems: [MenuItem] {
        return [
            MenuItem(sku: "00001", title: "La Niña Margarita", price: 5, description: "An elevated botanical Margarita with marigold & kaffir lime", size: "3.4oz", abv: "18", imageName: "la_nina")
        ]
    }
}
